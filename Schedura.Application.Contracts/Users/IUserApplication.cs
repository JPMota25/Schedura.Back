...
public interface IUserApplication {
	...
	Task<GetUsersReportByUiFiltersResponse> GetUsersReportByUiFiltersAsync(GetUsersReportByUiFiltersRequest request, CancellationToken cancellationToken = default);
}
